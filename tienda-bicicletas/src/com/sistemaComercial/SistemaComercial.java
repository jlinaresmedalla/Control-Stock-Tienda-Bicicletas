...
public class SistemaComercial {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SistemaComercial window = new SistemaComercial();
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(SistemaComercial.class.getResource("/com/recursos/logo3.png")));
		lblNewLabel.setBounds(32, 11, 282, 103);
		frameVentaBiciletas.getContentPane().add(lblNewLabel);
		
		JLabel etiquetaFondo = new JLabel("");
		etiquetaFondo.setVerticalAlignment(SwingConstants.TOP);
		etiquetaFondo.setIcon(new ImageIcon(SistemaComercial.class.getResource("/com/recursos/bg2.PNG")));
		etiquetaFondo.setBounds(0, 0, 605, 311);
