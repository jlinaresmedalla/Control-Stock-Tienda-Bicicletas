...
public class MenuPrincipal {
	...
	private void initialize() {
		...
		frameMenuPrincipal.setTitle("SISTEMA DE VENTA DE BICICLETAS");
		...
		menuArchivo.setFont(new Font("Tahoma", Font.BOLD, 12));
		menuBar.add(menuArchivo);
		
		JMenuItem ItemSalir = new JMenuItem("SALIR");
		ItemSalir.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0));
